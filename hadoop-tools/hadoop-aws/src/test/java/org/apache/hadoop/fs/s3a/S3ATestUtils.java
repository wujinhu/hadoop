...
import org.apache.hadoop.cloud.core.metadata.MetadataStoreCapabilities;
...
import static org.apache.hadoop.cloud.core.metadata.Constants.METASTORE_LOCAL;
...
public final class S3ATestUtils {
  ...
  public static void assumeS3GuardState(boolean shouldBeEnabled,
    ...
    boolean usingNullImpl = METASTORE_NULL.equals(
        conf.getTrimmed(S3_METADATA_STORE_IMPL, METASTORE_NULL));
    Assume.assumeThat("Unexpected S3Guard test state:"
            + " shouldBeEnabled=" + shouldBeEnabled
